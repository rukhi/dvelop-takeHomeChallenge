...
public class PatientService {
    ...
    public PersonDTO processPatient(Patient patient) {
        // Extrahieren & Übergeben der Patientendaten im PersonDTO-Objekt
        // -----------------------------------------------//
        ...
        //  Achtung: nur zum Testen auskommentieren, sensible Patientendaten sollten nicht geloggt werden
